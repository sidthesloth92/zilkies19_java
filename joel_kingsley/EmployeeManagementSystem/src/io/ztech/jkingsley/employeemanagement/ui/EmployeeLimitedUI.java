...
public class EmployeeLimitedUI {
	...
	public EmployeeLimitedUI(BigInteger empID) {
		super();
	...
	private EmergencyContact getInputForUpdateEmergencyContact() {
		...
		LOGGER.info("List of all emergency contacts of ID: " + empID);
	...
	private Phone getInputForUpdatePhone() {
		...
		LOGGER.info("List of all phone numbers of ID: " + empID);
