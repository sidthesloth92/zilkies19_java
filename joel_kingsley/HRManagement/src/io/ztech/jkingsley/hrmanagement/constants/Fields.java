package io.ztech.jkingsley.hrmanagement.constants;
...
public class Fields {
	...
	public static final String EMPLOYEE_KEY_AADHAR = "aadhar";
	public static final String EMPLOYEE_KEY_ACCOUNT_TYPE = "account_type";
	public static final String EMPLOYEE_KEY_BLOOD_GROUP = "blood_group";
	public static final String EMPLOYEE_KEY_DESIGNATION_ID = "designation_id";
	public static final String EMPLOYEE_KEY_DOB = "dob";
	public static final String EMPLOYEE_KEY_DOJ = "doj";
	public static final String EMPLOYEE_KEY_EMP_STATUS = "emp_status";
	public static final String EMPLOYEE_KEY_GENDER = "gender";
	public static final String EMPLOYEE_KEY_HIGHEST_QUALIFICATION = "highest_qualification";
	public static final String EMPLOYEE_KEY_MARITAL_STATUS = "marital_status";
	public static final String EMPLOYEE_KEY_PAN = "pan";
