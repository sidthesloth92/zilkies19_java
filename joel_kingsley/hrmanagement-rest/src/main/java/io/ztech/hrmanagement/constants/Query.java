...
public class Query {
	...
	public static final String UPDATE_EMERGENCY_CONTACT = "update " + Fields.TABLE_EMERGENCY_CONTACT + " set "
			+ Fields.EMERGENCY_CONTACT_KEY_NAME + " = ?, " + Fields.EMERGENCY_CONTACT_KEY_PHONE + " = ? where "
			+ Fields.EMERGENCY_CONTACT_KEY_ID + " = ?";
	...
	public static final String FIND_ALL_EMPLOYEE_IDS = "select emp_id from " + Fields.TABLE_EMPLOYEE;
