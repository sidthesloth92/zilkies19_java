...
public class ContactCreation extends ConnectionConfig {
	...
	public void creatingContact() {
		...
		if(validationObj.ifExists(firstName, lastName)) {
			...
			while(!validationObj.mobile(mobNumber)) {
			...
			while(emailCondition) {
				...
				while(!validationObj.email(email)) {
	...
	public void insertingContact(Contact contact) {
		try {
			...
			PreparedStatement preparedStmt = con.prepareStatement(constant.insertionIntoContactDetail);
			...
			ResultSet rs = st.executeQuery(constant.gettingID);
	...
	public void insertingMobileNumber(int latestId, Contact contact) {
		try {
			PreparedStatement preparedStmtMobileTable = con.prepareStatement(constant.insertionIntoMobile);
	...
	public void insertingHomeNumber(int latestId, Contact contact) {
		try {
			PreparedStatement preparedStmtHomeTable = con.prepareStatement(constant.insertIntoHome);
	...
	public void insertingOfficeNumber(int latestId, Contact contact) {
		try {
			PreparedStatement preparedStmtOfficeTable = con.prepareStatement(constant.insertIntoOffice);
	...
	public void insertingEmail(int latestId, Contact contact) {
		...
		while(itr.hasNext()) {
			try {
				PreparedStatement preparedStmtEmailTable = con.prepareStatement(constant.insertIntoEmail);
	...
	public void addAnotherNumber(String firstName, String lastName) {
		...
		try {
			PreparedStatement preparedStmt = con.prepareStatement(constant.searchingWithFirstName);
			...
			constant.addAnotherNumberPrint();
	...
	public void addMobile(String firstName, int contactID) {
		...
		try {
			PreparedStatement preparedStmtMobile = con.prepareStatement(constant.insertionIntoMobile);
	...
	public void addEmail(String firstName, int contactID) {
		...
		try {
			PreparedStatement preparedStmtEmail = con.prepareStatement(constant.insertIntoEmail);
	...
	public void addHome(String firstName, int contactID) {
		...
		try {
			PreparedStatement preparedStmtHome = con.prepareStatement(constant.insertIntoHome);
	...
	public void addOffice(String firstName, int contactID) {
		...
		try {
			PreparedStatement preparedStmtOffice = con.prepareStatement(constant.insertIntoOffice);
