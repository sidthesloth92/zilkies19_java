...
<body>
	...
	<!--[if lt IE 7]>
        ...
        <![endif]-->
	<!-- nav-bar -->
	<c:set var="list" value="${myProjectsList}" scope="session" />
					...
					<c:choose>
						<c:when test="${ empty list }">
							<div class="card card-2">
								<p class="box__project-name box__item">You currently have no
									Projects !</p>
							</div>
						</c:when>
						<c:otherwise>
												...
												<div class="user-location-projects__card-section">
													<div class="row">
														<div class="col-lg-12">
															...
															<p class="box__project-status box__item">${
                                                                    currentListItem.getProjectStatus() }</p>
															<div
															...
															<c:choose>
																<c:when
																	test="${ currentListItem.getProjectStatus() == 'Completed'}">
																...
																<c:otherwise>
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6">
																			<form method="POST"
																				action="Contractor?post-type=project-completed&project-id=${
                                                                    currentListItem.getProjectID() }">
																				<button class="form__button">Set as
																					Completed</button>
																			</form>
																		</div>
																		<div class="col-lg-3"></div>
																	</div>
																	<!--  Project Completed Button Ending  -->
																</c:otherwise>
															</c:choose>
														</div>
													</div>
