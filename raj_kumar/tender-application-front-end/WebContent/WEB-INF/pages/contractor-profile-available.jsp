...
<link rel="stylesheet"
	href=${pageContext.request.contextPath}/css/contractor-profile-available.css>
...
<body>
	<c:set var="list" value="${availableProjectsList}" scope="session" />
	...
	<div class="content-wrapper">
			...
			<div class="col-lg-8 c col-sm-12">
				...
				<div class="profile-section__details ">
					...
					<div class="profile-section__details__inner">
						<p class="profile-section__details__inner__items">Name: ${ userSession.getFirstName() }
							${ userSession.getLastName() }</p>
		...
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="tab">
					<a href="Contractor?getType=contractor-home">
						...
						<button type="submit" class="tab__links">View Available
							Projects</button>
					</a> <a href="Contractor?getType=view-delayed-project">
						<button class="tab__links">View Delayed Projects</button>
					</a> <a href="Contractor?getType=contractor-applied-project">
				...
				<div id="availableProjects" class="tabcontent">
												...
												<div class="user-location-projects__card-section">
													<div class="row">
                                                        ...
                                                        currentListItem.getProjectName() }</p>
															<p class="box__project-description box__item">${
                                                        currentListItem.getDescription() }</p>
															<div
																class="user-location-projects__card-section__location box__item">
																<p class="box__project-location">
																	<i
																		class="fas fa-map-marker-alt box-item__location-icon"></i>${
                                                            currentListItem.getLocation() }
																</p>
															</div>
															<div class="row">
																<div class="col-lg-4 col-sm-1"></div>
																<div class="col-lg-4 col-sm-10 drop-down-container">

																	

																		<a onclick="displayModal(${
                                                                currentListItem.getProjectID() })">
																		<i class="fas fa-chevron-down fa-2x" id="icon-${
                                                                currentListItem.getProjectID() }"></i>
																	</a> 
																</div>
																<div class="col-lg-4 col-sm-1"></div>
															</div>
															<div class="row contractor-project-application-section"
																id=${
                                                                    currentListItem.getProjectID() }>

																<div class="col-lg-12">
																	<form action="/TenderApplication/Contractor"
																		method="POST">
																		<input type="hidden"
																			value=${ currentListItem.getProjectID() }
																			name="project-id"> <label for="">Enter
																			the Start Date</label> <input type="date" class="form__input"
																			name="start-date"> <label for="">Enter
																			the End Date</label> <input type="date" class="form__input"
																			name="end-date"> <input type="text"
																			class="form__input" name="estimated-cost"
																			placeholder="Enter the Estimated Cost"> <input
																			type="hidden" name="post-type"
																			value="sending-request-for-project">
																		<div class="row">
																			<div class="col-sm-2 col-lg-4"></div>
																			<div class="col-sm-8 col-lg-4">
																				<button class="form__button" type="submit">Apply
																					Request</button>
																			</div>
			...
			<div id="myModal" class="modal">
				...
				<div class="modal-content">
					...
					<form action="/TenderApplication/Contractor" method="POST">
						<label for="">Enter the Start Date</label> <input type="date"
							class="form__input" name="start-date"> <label for="">Enter
							the End Date</label> <input type="date" class="form__input"
							name="end-date"> <input type="text" class="form__input"
							name="estimated-cost" placeholder="Enter the Estimated Cost">
						<input type="hidden" name="post-type"
							value="sending-request-for-project"> <input type="hidden"
							name="project-id" id="get-project-id" value=>
						<div class="row">
							<div class="col-sm-2 col-lg-4"></div>
							<div class="col-sm-8 col-lg-4">
								<button class="form__button" type="submit">Apply
