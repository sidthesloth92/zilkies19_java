...
<body>
	...
	<!--[if lt IE 7]>
        ...
        <![endif]-->
	<c:set var="list" value="${userProjectLocation}" scope="session" />
	<!-- nav-bar -->
													...
													<div class="row">
														<div class="col-lg-12">
															...
															<p class="box__project-description box__item">Lorem
																...
																Cumque voluptatibus maxime fugit, aperiam saepe
																temporibus,</p>
															...
															<div
																...
																<p class="box__project-location">
																	<i
																		class="fas fa-map-marker-alt box-item__location-icon"></i>Chennai,
																	Tamil Nadu
																</p>
															</div>
