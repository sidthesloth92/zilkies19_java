...
import io.ztech.onlinebidding.services.CheckUserName;
...
public class RegisterDetails implements ConstantDisplayStatement {
	...
	public void fetchRegisterDetails() {
		try {
			...
			do {
				username = fetchDetailsFromUser.fetchdetails(USERNAME_REGEX, ENTER_USERNAME, INVALID_USERNAME);
			} while (checkName.checkUserName(username));
