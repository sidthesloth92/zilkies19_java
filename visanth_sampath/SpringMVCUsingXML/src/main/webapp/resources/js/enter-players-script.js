	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	      ...
	      alert("sucess");
	      window.location.href="http://127.0.0.1:8080/FantasyLeague/PageRedirectionServlet?page-name=end-match";
	      //Current Rating : 10
	    }
	  };
	  xhttp.open("POST", "http://127.0.0.1:8080/FantasyLeague/EnterPlayingTeamServlet", true);
