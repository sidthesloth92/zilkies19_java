...
<head>
    ...
    <title>Fantasy Laegue</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://fonts.googleapis.com/css?family=Indie+Flower|Ruslan+Display" rel="stylesheet">
    <link href='https://fonts.googleapis.com/css?family=Allan' rel='stylesheet'>
    <link rel="stylesheet" type="text/css" media="screen" href="resources/css/commonstylesheet.css" />
    <link rel="stylesheet" type="text/css" media="screen" href="resources/css/indexstylesheet.css" />
</head>
        ...
        <div class="modal-inner">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8">
                    ...
                    <h3>Login</h3>
                    <form action="login" onsubmit="validateOnLogin()"  name="login-form">
