...
public class GeneralValidators {
	...
	public boolean checkScheduledDate(String scheduledDate) {
	    ...
	    try {
	        ...
	        if(!Character.isDigit(scheduledDate.charAt(0))||!Character.isDigit(scheduledDate.charAt(1)) || !Character.isDigit(scheduledDate.charAt(2))||!Character.isDigit(scheduledDate.charAt(3))|| !Character.isDigit(scheduledDate.charAt(5))||!Character.isDigit(scheduledDate.charAt(6))||!Character.isDigit(scheduledDate.charAt(8))||!Character.isDigit(scheduledDate.charAt(9))) {
	        	return false;
	        }
	    }
	    catch (Exception e) {
	...
	public boolean checkScheduledTime(String scheduledTime) {
	    ...
	    try {
	        ...
	        if(!Character.isDigit(scheduledTime.charAt(0))||!Character.isDigit(scheduledTime.charAt(1)) || !Character.isDigit(scheduledTime.charAt(3))||!Character.isDigit(scheduledTime.charAt(4))|| !Character.isDigit(scheduledTime.charAt(6))||!Character.isDigit(scheduledTime.charAt(7))) {
	        	return false;
	        }
	    }
	    catch (Exception e) {
