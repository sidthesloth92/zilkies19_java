...
public class SqlConstants {
	...
	public static final String SELECT_ACTIVE_MATCHES = "SELECT * FROM iplBetting.matches_scheduled INNER JOIN iplBetting.match_status WHERE matches_scheduled.scheduled_date >= current_date() AND iplBetting.matches_scheduled.match_id = iplBetting.match_status.match_id and match_status.is_upcomming=1";
	...
	public static final String SELECT_UPCOMMING_MATCHES = "SELECT * FROM matches_scheduled INNER JOIN match_status WHERE is_upcomming =1 AND matches_scheduled.match_id = match_status.match_id";
	...
	public static final String SELECT_RESULT_TABLE = "SELECT * FROM result_board INNER JOIN users WHERE users.user_id = result_board.user_id AND match_id =? ORDER BY result_board.match_points desc";
	...
	public static final String SELECT_PLAYER_WITH_ID = "SELECT * FROM player where player_id = ? ";
	public static final String SELECT_TEAM_NAMES = "SELECT * FROM team";
	public static final String SELECT_PLAYER_NAMES = "SELECT * FROM player";
	public static final String SELECT_PLAYER_IDS = "SELECT * FROM player";
	public static final String SELECT_COMPLETED_MATCHES = "SELECT * FROM matches_scheduled INNER JOIN match_status WHERE match_status.is_upcomming = 0 AND matches_scheduled.match_id = match_status.match_id";
}
