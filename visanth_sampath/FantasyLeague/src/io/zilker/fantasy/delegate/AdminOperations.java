...
public class AdminOperations {
	...
	public boolean scheduleNewMatch(String teamOne, String teamTwo, String scheduledDate, String startTime,
	...
	// add a player
	public boolean addPlayer(String playerName, String team, String role, int rating) {
...
//			rating = adminService.getIntInputs();
	...
	//playing team
	public ArrayList<Player> getTeamOne(int matchId){
		match = userDAO.setMatch(matchId);
		return userDAO.displayTeam(match.getTeamOne());
	}
	
	//playing team two
		public ArrayList<Player> getTeamTwo(int matchId){
			match = userDAO.setMatch(matchId);
			return userDAO.displayTeam(match.getTeamTwo());
		}
	
	
	// enter playing 11
	public boolean endMatch(int matchId, ArrayList<Integer> playersInTeam) {
	...
	//get current rating 
	public int getCurrentRating(int playerId) {
		int currentRating = adminDAO.viewCurrentRating(playerId);
	...
	// edit Player Rating
	public boolean editPlayerRating(int playerId , int modifiedRating) {
//		int modifiedRating;
...
//			} while (!isValid);
//			isValid = false;
			isValid = adminDAO.modifyPlayerRating(playerId, modifiedRating);
//			if (isValid == true) {
...
//			}
	...
	//display on going matches
	public ArrayList<Match> displayOngoingMatches(){
		return adminDAO.displayOngoingMatches();
	}
	
	//get Team Names
	public ArrayList<String> getTeamNames(){
		return adminDAO.getTeamNames();
	}
	
	//get player names
	public ArrayList<String> getPlayerNames(){
		return adminDAO.getPlayerNames();
	}
	
	//get player names
		public ArrayList<String> getPlayerIds(){
			return adminDAO.getPlayerIds();
		}
}
