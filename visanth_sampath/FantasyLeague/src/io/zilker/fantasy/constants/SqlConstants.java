...
public class SqlConstants {
	...
	public static final String SELECT_ACTIVE_MATCHES = "SELECT * FROM iplBetting.matches_scheduled INNER JOIN iplBetting.match_status WHERE iplBetting.matches_scheduled.end_time > current_timestamp() AND matches_scheduled.scheduled_date >= current_date() AND iplBetting.matches_scheduled.match_id = iplBetting.match_status.match_id;";
