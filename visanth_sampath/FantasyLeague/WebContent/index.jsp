...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/css/indexstylesheet.css" />
</head>
        ...
        <div class="modal-inner">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8">
                    ...
                    <h3>Login</h3>
                    <form action="${pageContext.request.contextPath}/TestServlet" onsubmit="validateOnLogin()" method="POST" name="login-form">
