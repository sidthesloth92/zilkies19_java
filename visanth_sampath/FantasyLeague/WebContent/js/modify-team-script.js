...
var url ="http://127.0.0.1:8080/FantasyLeague/GetUserTeamServlet?match-id="+matchId;
	...
	var xhttp = new XMLHttpRequest();
	  xhttp.onreadystatechange = function() {
	    if (this.readyState == 4 && this.status == 200) {
	      ...
	      alert("sucess");
	      window.location.href="http://127.0.0.1:8080/FantasyLeague/PageRedirectionServlet?page-name=available-matches";
	      
	    }
	  };
	  xhttp.open("POST", "http://127.0.0.1:8080/FantasyLeague/UpdateTeamServlet", true);
