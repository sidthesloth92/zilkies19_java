<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="io.zilker.fantasy.delegate.AdminOperations , java.util.ArrayList " %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/css/editratingstylesheet.css" />
</head>
<body>
    <div class="header">
    ...
    <script src="${pageContext.request.contextPath}/js/editrating-script.js"></script>
