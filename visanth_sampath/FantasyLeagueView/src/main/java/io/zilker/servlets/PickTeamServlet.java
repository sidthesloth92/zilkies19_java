...
/**
 * Servlet implementation class PickTeamServlet
 */
@WebServlet("/PickTeamServlet")
public class PickTeamServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PickTeamServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/pages/pick-team.jsp");
