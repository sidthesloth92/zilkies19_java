...
<%@ page import=" io.zilker.fantasy.bean.Player, io.zilker.fantasy.bean.User , javax.servlet.http.HttpServlet , java.util.ArrayList " %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<c:url value = '/resources/css/viewteamstylesheet.css' />" />
...
<form action="ModifyTeamServlet" action="get">
...
<!--  chat block ending -->
    ...
    <script src="<c:url value = '/resources/js/view-team-script.js' />"></script>
</body>
</html>