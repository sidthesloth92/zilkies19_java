<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="io.zilker.fantasy.bean.User , io.zilker.fantasy.bean.Match ,io.zilker.fantasy.bean.ResultBoard , java.util.ArrayList " %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<c:url value = '/resources/css/toppicksstylesheet.css '/>" />
    ...
    <div class="container">
        <div class="flex-row">
             	...
             	<!-- start of match card1 -->
                        <div class="match-card row">
                                ...
                                <div class="col-sm-8 col-md-6 col-lg-6">
		                                <button class="team-names" value="<c:out value="${match.getMatchId()}" />" onclick="updateTopPicks()"><h3 class="team-name"> <c:out value="${match.getTeamOne()}" /> vs <c:out value="${match.getTeamTwo()}" /></h3></button>
                                </div>
                                <div class="col-sm-2 col-md-3 col-lg-3">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 ">
                ...
                <div class="leaderboard-heading">Top-picks</div>
                <div class="records-block">
                    Please select any match!
                </div>
...
<!--  chat block ending -->
    ...
    <script src="<c:url value = '/resources/js/toppicks-script.js '/>"></script>
