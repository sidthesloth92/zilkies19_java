            ...
            <div class="col-sm-12 col-md-6 col-lg-6 team-card_outer-container">
                  ...
                  <div class="leaderboard-heading">Playing Team</div>
		                <div class="row table_heading">
                         ...
                         <input type="text" name="match-credits" id="match-credits" value="<c:out value="${matchCredits}" />" hidden />
...
<!--  chat block ending -->
    ...
    <script src="<c:url value = '/resources/js/modify-team-script.js' />"></script>
