<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import=" io.zilker.fantasy.bean.Match , java.util.ArrayList " %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<c:url value = '/resources/css/addplayerstylesheet.css' />" />
...
<body>
    ...
    <script src="<c:url value = 'resources/js/addplayer-script.js ' />"></script>
