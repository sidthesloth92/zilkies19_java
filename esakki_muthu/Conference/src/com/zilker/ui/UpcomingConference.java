...
import com.zilker.service.UpcomingConferenceService;

public class UpcomingConference {

	Logger logger = Logger.getLogger(UpcomingConference.class.getName());

	public void getHistory(UserData userData) {

		UpcomingConferenceService upcomingConferenceService = new UpcomingConferenceService();

		ArrayList<ConferenceData> list = upcomingConferenceService.getHistory(userData);
