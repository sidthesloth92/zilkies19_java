...
public class Validation {
	...
	static boolean validatemobile(String cc, String mobile) {
	...
	static boolean validatehome(String area, String home) {
	...
	static boolean validateoffice(String exten, String office) {
