    ...
    <div class="user-request-container">
        <div class="topbar">
  			...
  			<div class="user-container">
                ...
                <div class="user-container-username">
                    ...
                    <div class="user-container-dropdown">
                        ...
                        <div>
                            <p onclick="window.location='/autoratefe/FetchAddCarServlet'">Add Car Request</p>
                        </div>
            ...
            <div class="login-container">
                ...
                <div class="signup">
                    <label>New user? <a onclick="window.location='/autoratefe/FetchSignupServlet'">Signup</a></label>
                </div>
            </div>
			<%
  			}
