...
<%@ page import="io.ztech.autorate.delegates.AddRatingDelegate"%>
	...
	<div class="car-container">
		...
		<div class="topbar">
			...
			<div class="logo-container">
				<img src="${pageContext.request.contextPath}/images/logo-green.png"
					alt="Logo" onclick="window.location='/autoratefe/index.jsp';">
			</div>
		...
		<div class="inner-container">
			<div class="inner-container-car">
				...
				%>
				<form action="/autoratefe/EditRatingServlet"
				...
				%>
				<form action="/autoratefe/AddReviewRatingServlet"
					class="inner-container-write-review">
