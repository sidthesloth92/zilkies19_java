...
function getSpecs(request) {
    ...
    xhttp.open("GET", "/autoratefe/FetchCarSpecsServlet?id="+specs.id, true);
    xhttp.send();
}
...
function approveRequest(request) {
    ...
    xhttp.open("GET", "/autoratefe/ApproveRequestServlet?carId="+req.getElementsByClassName("user-request-specs")[0].id+"&requestId="+req.getElementsByClassName("user-request-specs")[0].parentNode.id, true);
    xhttp.send();
}
...
function declineRequest(request) {
    ...
    xhttp.open("GET", "/autoratefe/DeclineRequestServlet?carId="+req.getElementsByClassName("user-request-specs")[0].id+"&requestId="+req.getElementsByClassName("user-request-specs")[0].parentNode.id, true);
    xhttp.send();
}
