        ...
        <div class="signup-inner-container">
            ...
            <div class="signup-inner-container-info">
                ...
                <div class="logo-container">
                    <img src="${pageContext.request.contextPath}/images/logo-blue.png" alt="Logo" class="logo" onclick="window.location='../index.jsp';">
                </div>
            ...
            <div class="signup-inner-container-main">
                ...
                <form action="/Autorate/SignupServlet" onsubmit="return validateSignupForm()" name="signup-form" method="POST">
                    <h2>Signup</h2>
