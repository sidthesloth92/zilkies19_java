...
<body>
    ...
    %>
     ...
     <div class="topbar">
            <div class="logo-container">
                <img src="${pageContext.request.contextPath}/images/logo-green.png" alt="Logo" onclick="window.location='/Autorate/IndexServlet';">
            </div>
            ...
            <div class="user-container">
                ...
                <div class="user-container-username">
                    ...
                    <div class="user-container-dropdown">
                        <div>
                            <p onclick="window.location='/Autorate/FetchRequestsServlet';">Your Requests</p>
                        </div>
                        <div>
    ...
    %>
            ...
            <form action="/Autorate/AddCarServlet" class="inner-container" onsubmit="return validateAddCarForm()">
				...
				<%if(session.getAttribute("status")!=null&&session.getAttribute("status").equals("ADMIN")) {%>
				<input type="text" placeholder="New Make" name="make-name">
				<%
					}
				%>
				...
				<%if(session.getAttribute("status")!=null&&session.getAttribute("status").equals("ADMIN")) {%>
				<input type="text" placeholder="New Car Type" name="cartype-name">
				<%
					}
				%>
