...
function getMakes() {
    ...
    xhttp.open("GET", "/Autorate/FetchMakesServlet?carTypeId="+carTypeId, true);
    xhttp.send();
}
...
function getCars() {
           ...
           for(var i=0;i<cars.length;i++) {
	            div= document.createElement("div");
	       	    ...
	       	    name.addEventListener("click", function myFunction() {
	       	    	window.location='/Autorate/CarServlet?id=' + this.id;
	       	    });
    ...
    xhttp.open("GET", "/Autorate/FetchCarsServlet?makeId="+makeId+"&carTypeId="+carTypeId, true);
    xhttp.send();
