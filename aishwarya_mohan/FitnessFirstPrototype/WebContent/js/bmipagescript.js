...
function showResultBox() {
    if ((document.forms["bmi-input-form"]["height-metric"].value != 0 && document.forms["bmi-input-form"]["weight-metric"].value != 0) || (document.forms["bmi-input-form"]["height-imperial-feet"].value != 0 && document.forms["bmi-input-form"]["height-imperial-inches"].value != 0 && document.forms["bmi-input-form"]["weight-imperial"].value != 0)) {
        calculateResult();
        document.getElementsByClassName("bmi-result")[0].classList.add("result-show");
        document.getElementsByClassName("bmi-comment")[0].classList.add("comment-show");
    }
}
...
function calculateResult() {
    ...
    if (document.getElementById("measurement-system-toggle_metric").classList.contains("chosen")) {
        ...
        var height = document.forms["bmi-input-form"]["height-imperial-feet"].value * 12 + document.forms["bmi-input-form"]["height-imperial-inches"].value;
        var weight = document.forms["bmi-input-form"]["weight-imperial"].value;
        result = (weight / (height * height)) * 703;
    }
    result = result.toFixed(2);

    document.getElementsByClassName("bmi-value")[0].getElementsByTagName("span")[1].innerHTML = result;
    ...
    document.getElementsByClassName("bmi-status")[0].getElementsByTagName("span")[1].innerHTML = category;
    document.getElementsByClassName("bmi-comment")[0].innerHTML = comment + "<span>Stay Fit 'n Flair :)</span>";
}