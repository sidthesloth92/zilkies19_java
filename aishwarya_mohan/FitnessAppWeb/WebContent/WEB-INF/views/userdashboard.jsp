...
<body onload="getTarget('${userProfile.getTarget()}')">
	...
	<div class="main-content">
			...
			<div class="bmr-wrapper col-sm-12 col-md-10 col-lg-5">
				...
				<div class="bmr-content-wrapper col-sm-9 col-md-9 col-lg-9">
					...
					<div class="bmr-content row" id="bmr-plans">
						...
						<form>
							<div>
								<input type="radio" name="plan" id="plan1" value="1"> <label
									for="plan1">Intake <c:out
										value="${userProfile.getTdee()}" />cal/day to maintain your
									current weight
								</label>
							</div>
							<div>
								<input type="radio" name="plan" id="plan2" value="2"> <label
									for="plan2">Intake <c:out
										value="${userProfile.getTdee()}-500" />cal/day to lose 0.5
									kg/week
								</label>
							</div>
							<div>
								<input type="radio" name="plan" id="plan3" value="3"> <label
									for="plan3">Intake <c:out
										value="${userProfile.getTdee()}-1000" />cal/day to lose 1
									kg/week
								</label>
							</div>
							<div>
								<input type="radio" name="plan" id="plan4" value="4"> <label
									for="plan4">Intake <c:out
										value="${userProfile.getTdee()}+500" />cal/day to gain 0.5
									kg/week
								</label>
							</div>
							<div>
								<input type="radio" name="plan" id="plan5" value="5"> <label
									for="plan5">Intake<c:out
		...
		<div class="features-display row">
			<div class="food-tracker_feature col-sm-10 col-md-5 col-lg-5">
				<img src="${pageContext.request.contextPath}/assets/food1.jpg"
					alt="food picture">
				<p>Track your food intake to achieve your fitness goal</p>
			</div>
			<div class="weight-tracker_feature col-sm-10 col-md-5 col-lg-5">
		...
		<div><a href="TrackerServlet">Go To Tracker</a></div>
	</div>
