...
public class SqlConstants {
	...
	public static final String UPDATE_STUDENT = "UPDATE student_details SET student_registration_number=?, student_name=?, college_code=?, department=?, semester=? WHERE student_registration_number=?";
	public static final String UPDATE_FACULTY = "UPDATE faculty_details SET faculty_registration_number=?, faculty_name=?, college_code=?, department=? WHERE faculty_registration_number=?";
	public static final String UPDATE_SUBJECT = "UPDATE subject_details SET subject_code=?, subject_name=? WHERE subject_code=?";
	public static final String UPDATE_COLLEGE = "UPDATE college_details SET college_code=?, college_name=? WHERE college_code=?";
	public static final String GET_ALL_SUBJECT_DETAILS_NOT_ENROLLED="SELECT * FROM subject_details WHERE subject_code NOT IN (SELECT subject_code FROM faculty_subject_details WHERE faculty_registration_number=?)";
}
