var matchNo;
		function updateScore() {
			...
			xhttp.open("GET",
					"http://localhost:8080/CricketTournament/UpdateScore?runs="
		...
		function fetchScorecard() {
			...
			xhttp.open("POST",
					"http://localhost:8080/CricketTournament/UpdateScore?teamname="
		...
		function filterTournament() {
			...
			xhttp.open("POST",
					"http://localhost:8080/CricketTournament/Scorecard?tournamentname="
							+ tournamentName + "", true);
			xhttp.send();
		}
