...
<script type="text/javascript"
	src=${PageContext.request.contextPath}/CricketTour/js/ApproveRequest.js></script>
</head>
<body>
	...
	<div class="user-container" id="home-container">
		...
		<div class="tournament-container">
			<div class="tournament-container__sidenav">
				<a
					href="http://localhost:8080/CricketTour/LoginServlet?method=admin">Home</a>
				<a href="http://localhost:8080/CricketTour/ViewRequest">View
					Request</a> 
			</div>
