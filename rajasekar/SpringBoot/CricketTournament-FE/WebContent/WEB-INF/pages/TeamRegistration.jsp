...
<link rel="stylesheet"
	href="${PageContext.request.contextPath}/CricketTour/css/TeamRegistration.css">
<link rel="stylesheet"
	...
	<div class="user-container">
		...
		<div class="tournament-container">
			...
			<form name="registerForm" method="post"
				action="http://localhost:8080/CricketTour/RegisterTeam?tourname=<%=tournamentName%>&email=<%=email%>">
				<div class="form-card">
