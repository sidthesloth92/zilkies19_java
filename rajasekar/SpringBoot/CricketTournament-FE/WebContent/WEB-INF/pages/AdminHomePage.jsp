...
<link rel="stylesheet"
	href=${PageContext.request.contextPath}/CricketTour/css/AdminHomePage.css>
<link rel="stylesheet"
	href="https://use.fontawesome.com/releases/v5.2.0/css/all.css"
	integrity="sha384-hWVjflwFxL6sNzntih27bfxkr27PmbbK/iSvJ+a4+0owXq79v+lsFkW54bOGbiDQ"
	crossorigin="anonymous">
<script type="text/javascript"
	src=${PageContext.request.contextPath}/CricketTour/js/AdminHomePage.js></script>
</head>
	...
	<div class=" user-container" id="home-container">
		...
		<div class="tournament-container ">
			<div class="tournament-container__sidenav ">
				<a href="http://localhost:8080/CricketTour/LoginServlet?method=admin">Home</a>
				<a href="http://localhost:8080/CricketTour/ViewRequest">View Request</a>
			</div>
					...
					<div class="card-border ">
						<div class="card-1 ">
							<div class="card-1__image ">
								<img src="/CricketTour/images/kohli.jpg " alt="Avatar "
