...
function isValidUser() {
	...
	$(document).ready(function () {
			$.ajax({
				url: 'http://localhost:8080/CricketTour/LoginServlet?method=emailvalidation',
				method: 'GET',
				data: {
					email: $('#email').val(),
...
function isValidPassword() {
	...
	$(document).ready(function () {
			$.ajax({
				url: 'http://localhost:8080/CricketTour/LoginServlet?method=credentialsvalidation',
				method: 'GET',
				data: {
					email: $('#email').val(),
...
function isEmailTaken() {
	...
	$(document).ready(function () {
			$.ajax({
				url: 'http://localhost:8080/CricketTour/LoginServlet?method=emailtaken',
				method: 'GET',
				data: {
					email: $('#regemail').val()
				},
...
function getTeam(clicked_id){
	...
	console.log(x);
	document.location.href = "http://localhost:8080/CricketTour/RegisterTeam?tourname="+x+"";
}