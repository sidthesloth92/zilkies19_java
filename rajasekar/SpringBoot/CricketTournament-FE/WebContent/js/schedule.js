function updateScore() {
		...
		xhttp.open("GET",
				"http://localhost:8080/CricketTour/ViewScorecard?runs="
	...
	function fetchScorecard() {
		...
		xhttp.open("POST",
				"http://localhost:8080/CricketTour/ViewScorecard?teamname="
	...
	function filterTournament() {
		...
		xhttp.open("POST",
				"http://localhost:8080/CricketTour/ViewSchedule?tournamentname="
						+ tournamentName + "", true);
		xhttp.send();
	}
